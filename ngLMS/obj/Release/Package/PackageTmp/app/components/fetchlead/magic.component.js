...
var MagicComponent = /** @class */ (function () {
    function MagicComponent(Lead, sideBarService, user, alert, authenticationService) {
        var _this = this;
        this.Lead = Lead;
    ...
    MagicComponent.prototype.ngOnInit = function () {
        this.sideBarService.setPageTitle('Magic Bricks Api');
    };
    MagicComponent.prototype.getLastFetchDetails = function () {
        var _this = this;
        this.isLoading = true;
        this.Lead.getLastFetch('1').subscribe(function (data) {
    ...
    MagicComponent.prototype.fetchLead = function () {
        var _this = this;
...
exports.MagicComponent = MagicComponent;
