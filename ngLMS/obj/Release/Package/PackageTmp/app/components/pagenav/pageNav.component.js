...
var PageNavComponent = /** @class */ (function () {
    ...
    PageNavComponent.prototype.getReminderForUser = function (uid) {
        var _this = this;
        ...
        this.Lead.getReminderCount(uid).subscribe(function (data) {
            _this.ReminderCount = data;
        }, function (error) {
        });
    };
    PageNavComponent.prototype.updateReminderCount = function (uid) {
        var _this = this;
        this.Lead.getReminderCount(uid).subscribe(function (data) {
            _this.ReminderCount = data;
        }, function (error) {
    ...
    PageNavComponent.prototype.ngOnInit = function () {
        ...
        this.sideBarService.UpdateReminderCount.subscribe(function (uid) { _this.getReminderForUser(uid); _this.uid = uid; });
