                ...
                router_1.RouterModule.forRoot([
                    ...
                    { path: 'login', component: index_1.LoginComponent },
                    {
                        path: 'leads', component: index_1.NavMenuComponent, children: [
                            { path: 'leadManager', component: index_1.LeadManagerComponent, canActivate: [index_3.AuthGuard] },
                            { path: 'reminders', component: index_1.ReminderDetailsComponent, canActivate: [index_3.AuthGuard] }
                        ]
                    },
                    {
                        path: 'home', component: index_1.NavMenuComponent, children: [
                            { path: 'createUser', component: index_1.CreateUserComponent, canActivate: [index_3.AuthGuard] },
                            { path: 'magicbricks', component: index_1.MagicComponent, canActivate: [index_3.AuthGuard] },
                            { path: '99acre', component: index_1.AcreComponent, canActivate: [index_3.AuthGuard] },
                            { path: 'housing', component: index_1.HousingComponent, canActivate: [index_3.AuthGuard] },
                        ], canActivate: [index_3.AuthGuard]
                    },
                    {
                        path: 'project', component: index_1.NavMenuComponent, children: [
                            { path: 'details', component: index_1.ProjectComponent, canActivate: [index_3.AuthGuard] }
                        ], canActivate: [index_3.AuthGuard]
                    },
                    {
                        path: 'customer', component: index_1.NavMenuComponent, children: [
                            { path: 'privilage', component: index_1.PrivilageCustomer, canActivate: [index_3.AuthGuard] }
                        ], canActivate: [index_3.AuthGuard]
                    },
