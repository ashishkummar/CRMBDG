...
var ReminderDetailsComponent = /** @class */ (function () {
    function ReminderDetailsComponent(Lead, sideBarService, user, alert, authenticationService, route) {
        var _this = this;
        this.Lead = Lead;
    ...
    ReminderDetailsComponent.prototype.LoadReminderForUser = function (uid) {
        var _this = this;
        this.isLoading = true;
        this.Lead.getReminders(uid).subscribe(function (data) {
    ...
    ReminderDetailsComponent.prototype.LoadAllReminderForUser = function (uid) {
        var _this = this;
        this.isLoading = true;
        this.Lead.getAllReminders(uid).subscribe(function (data) {
            _this.rowData = JSON.parse(data);
            _this.isLoading = false;
        }, function (error) {
            _this.isLoading = false;
    ...
    ReminderDetailsComponent.prototype.downloadPdf = function () {
        var _this = this;
        this.isLoading = true;
