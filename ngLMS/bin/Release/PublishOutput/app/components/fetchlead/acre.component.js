...
var AcreComponent = /** @class */ (function () {
    ...
    AcreComponent.prototype.fetchLead = function () {
        ...
        if (datDif > 30) {
            this.alert.error("30 Days record is allowed at a time");
            return false;
        }
        this.isLoading = true;
        this.Lead.getAcreLead(this.apiUserID, this.apiPassword, this.searchFromDt, this.searchToDt).subscribe(function (data) {
