...
var HousingComponent = /** @class */ (function () {
    function HousingComponent(Lead, sideBarService, user, alert, authenticationService) {
        var _this = this;
        this.Lead = Lead;
        ...
        this.searchFromDt.setDate(this.searchFromDt.getDate() - 0);
    ...
    HousingComponent.prototype.getLastFetchDetails = function () {
        var _this = this;
        this.isLoading = true;
        this.Lead.getLastFetch('3').subscribe(function (data) {
    ...
    HousingComponent.prototype.fetchLead = function () {
        var _this = this;
        ...
        this.isLoading = true;
        this.Lead.getHousingLead(this.searchFromDt, this.searchToDt).subscribe(function (data) {
...
exports.HousingComponent = HousingComponent;
